...
/**
 * Follow the tutorial {@link <a href="http://wiremock.org/docs/https/">WireMock HTTPS/SSL</a>}.
 */
public class HttpsMockSecureWithBasicAuthenticationTest {
    private static final String APP_ROOT = "/reportws/rest/reportExecutions";

    @Rule
    public WireMockRule wireMockRule = new WireMockRule(wireMockConfig()
            .dynamicHttpsPort()
            .keystorePath(new File("./target/keystore.jks").getPath())
            .keystorePassword("test rest")
            .needClientAuth(true)
    );
    ...
    public void shouldPostPDF() throws Exception {
        ...
        URI appRoot = new URI("https", null, "localhost", wireMockRule.httpsPort(), APP_ROOT, null, null);
        ...
        s.initAsTest(new URI("https", "username:pswd", "localhost", wireMockRule.httpsPort(), APP_ROOT, null, null).toURL(),
                new File("./target/keystore.jks"), "test rest");
